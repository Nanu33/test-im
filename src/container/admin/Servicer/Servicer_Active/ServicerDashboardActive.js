...
class ServicerDashBoardActive extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedRecords: [],
  ...
  ViewDetails = async (value) => {
    ...
    sessionStorage.setItem("component", "/admin/servicer_active");
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <div className="page">
          <Sidebar activeComponent={"ServicerDashBoardActive"} />
...
export default withSnackbar(ServicerDashBoardActive);
