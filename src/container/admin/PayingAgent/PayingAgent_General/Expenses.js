...
class Expense_DealCreation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tableData: [],
  ...
  onOpenModal = () => {
    console.log("add expenses modal");
    this.setState({
      open1: true,
      formData: {
        "Expense Name": "",
  ...
  onOpenModal1 = (value, editValue) => {
    ...
    console.log("edit expenses modal");
    this.setState({
  ...
  onOpenModal2 = (value, deleteValue) => {
    ...
    console.log("delete expenses modal");
    this.setState({
      open3: true,
      deleteRowVal: {
        "Expense Name": value,
        Category: deleteValue,
      },
    });
  };
  ...
  dealCreationDelete = async () => {
    ...
    const NameAdd1 = this.state.deleteRowVal["Expense Name"];
    const Obj = {
      [`${NameAdd1}`]: {
  ...
  dealCreationAddSave = async () => {
    this.setState({ formLoader: true });
      ...
      data.DealName = this.state.DealName;
      data.TableName = this.state.TableName;
      const NameAdd = this.state.formData["Expense Name"];
      const ObjAdd = {
        [`${NameAdd}`]: {
          ...this.state.formData,
        },
  ...
  dealCreationEdit = async () => {
    this.setState({ formLoader: true });
      ...
      const NameAdd = this.state.formData1["Expense Name"];
      const ObjAdd = {
        [`${NameAdd}`]: {
  ...
  goBackToDashBoard = () =>{
    this.state.isRecurring
      ...
      : this.props.history.push({
      pathname: '/admin/expenses_recurring',
    });
  };
  getMuiTheme = () =>
    createMuiTheme({
                ...
                <div className="">
                  <span>
                    <button
                      ...
                      onClick={() =>
                        this.onOpenModal1(value, tableMeta.rowData[1])
                      }
                    >
                      Edit
                    </button>
              ...
              <div className="page-content">
                ...
                <div className="row row1">
                  <div className="investor-heading-container">
                    <h1 className="headerdashboard1">List of Expenses</h1>
                  </div>
                  <div>
                        ...
                        >
                          <div className="input-container">
                            ...
                            <input
                              ...
                              value={this.state.formData["Expense Name"]}
                            />
                          </div>
                        ...
                        >
                          <div className="input-container">
                            ...
                            <input
                              ...
                              value={this.state.formData1["Expense Name"]}
                            />
                          </div>
                          ...
                          <div className="input-container">
                            ...
                            <select
                              ...
                              value={this.state.formData1.Category}
                            >
                              <option value="">Select any one</option>
                              <option value="Closing">Closing</option>
                              <option value="General">General</option>
                    ...
                    <React.Fragment>
                      <div className="modalPopup">
                        <h3 className="popupheading">
                          ...
                          {this.state.deleteRowVal["Expense Name"]}"?
                        </h3>
...
export default withSnackbar(Expense_DealCreation);
