...
class Variables_DealCreation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tableData: [],
  ...
  onOpenModal1 = (value, editValue) => {
    ...
    this.setState({
      ...
      formData1: {
        ...
        "Report Section": !editValue[2] ? "NA" : editValue[2],
        "Data Type": !editValue[3] ? false : editValue[3],
      },
  ...
  showPrev = (e) => {
    ...
    this.setState({
      ...
      activeInsights4: false,
      activeInsights5: false,
      activeInsights6: activeInsights7Value,
      activeInsights7: false,
      activeInsights8: false,
  ...
  goBackToDashBoard = () => {
    this.state.isRecurring
      ...
      : this.props.history.push({
          pathname: "/admin/variable_recurring",
        });
  };
  getMuiTheme = () =>
    createMuiTheme({
                ...
                >
                  <span>
                    ...
                    <button
                      ...
                      onClick={() =>
                        this.onOpenModal3(value, tableMeta.rowData.splice(1, 4))
                      }
                    >
                      Delete
                    </button>
              ...
              <div className="page-content">
                ...
                <div className="row row1">
                  <div className="investor-heading-container">
                    <h1 className="headerdashboard1">List of Variables</h1>
                  </div>
                  <div>
                     ...
                     <h2>Add Variable</h2>
                      ...
                      <div className="modalshiftcontent">
                        ...
                        >
                          ...
                          <div className="input-container">
                            <label className="label">Report Section</label>
                            <select
                              ...
                              onChange={(e) => {
                                this.setState({
                                  formData: {
                                    ...this.state.formData,
                                    "Report Section": e.target.value,
                                  },
                                });
                              }}
                              value={this.state.formData["Report Section"]}
                            >
                              <option value="NA">Select any one</option>
                              <option value="Structural Features">
                                Structural Features
                              </option>
                            </select>
                          </div>
                    ...
                    <div className="modalshiftcontent">
                      <form className="form-container">
                        <div className="Modal-Data">
                          ...
                          <div className="headingspaces1">
                            <p className="sizeofp">Report Section</p>
                            <h6 className="headingspace1">
                              {!this.state.formData1["Report Section"]
                                ? "NA"
                                : this.state.formData1["Report Section"]}
                            </h6>
                          </div>
                        ...
                        >
                          ...
                          <div className="input-container">
                            ...
                            <select
                              ...
                              value={this.state.formData1["Report Section"]}
                            >
                              <option value="NA">Select any one</option>
                              <option value="Structural Features">
                                Structural Features
...
export default withSnackbar(Variables_DealCreation);
