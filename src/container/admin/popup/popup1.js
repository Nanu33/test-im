...
import { customStylesautosmallmodalpopup } from '../../../components/customscripts/customscript';
import { getuserbyid } from '../../../servies/services';
...
class popup1 extends Component {
  ...
  handleClick = () => {
    // history.push({
    //   pathname: '/kycattestination'
    // });
    window.location.assign('/kycattestination')
  }
  ...
  getuserbyid = async () => {
    ...
    let userrole = params.get('userrole');
    let username = params.get('username');
    let organizationname = params.get('organizationname');
    this.setState({ userid: userid, username: username, organizationname: organizationname, userrole: userrole });
    ...
    if (APIResponse.status === 200) {
      ...
      if (APIResponse.data.KycUploadStatus == 'No') {
            ...
            >
              <div className="new-modal-popup">
                ...
                <div className='popupheading'>
                  <h4>Welcome To Intain Markets!</h4>
                </div>
                <h6 className="card1__title">To access your account, you will need to complete the onboarding process.</h6>
...
export default withSnackbar(popup1);
