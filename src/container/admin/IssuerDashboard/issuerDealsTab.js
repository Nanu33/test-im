...
class IssuerDealsTab extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedRecords: [],
            ...
            return (
              <React.Fragment>
                ...
                <div className='text-center'>
                  ...
                  <buton type="button" onClick={() => this.viewdetails(value)} className="login-sign_up-links">View Details</buton>
                  {/* </Button> */}
...
export default withSnackbar(IssuerDealsTab);
