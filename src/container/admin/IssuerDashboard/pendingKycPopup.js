...
class PendingKYCPopup extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selectedRecords: [],
                        ...
                        >
                            <div className="new-modal-popup">
                                ...
                                <div className='popupheading'>
                                    <h4>USER ACCOUNT REGISTERED</h4>
                                </div>
                                <h6 className="card1__title">An Intain representative will contact you within 24 hours to finalize the onboarding process,at which point your Account will be unlocked.Thank you.</h6>
...
export default withSnackbar(PendingKYCPopup);
