...
class VA_Pooldetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedRecords: [],
      ...
      VaToken: sessionStorage.getItem("VaToken"),
      bdbURL: "",
      typeOfBdb: "strat",
      UrlBdbNew:
  ...
  updateVAcertificate = async () => {
    this.setState({ formLoader: true });
    var data = {};
    data.poolid = this.state.pooldetails.poolID;
    data.issuerId = this.state.pooldetails.issuerId;
    data.VAToken = this.state.VaToken;
    data.token = this.state.token;
    const APIResponse = await updateVAcertificate(data);
    console.log(APIResponse);
    if (APIResponse.status === 200) {
      if (APIResponse.data.isSuccess === true) {
        this.setState({ formLoader: false });
        ...
        <div className="page">
                ...
                <div className="row">
                  <div className="col-12 col-sm-6 col-md-8">
                    <div className="d-flex">
                      ...
                      {/* <button >Update VA Certificate</button> */}
                    </div>
                  ...
                  <div className="col-12 col-sm-6 col-md-4 hellocard">
                    <div className="buttonsverified1">
                      {/* <Button
                                                variant="contained"
                                                color="primary"
                                                onClick={this.updateVAcertificate}
                                            >
                                                Update VA Certificate
                        ...
                        <TableVirtuoso
                                ...
                                {this.state.columns?.map((column) => (
                                  <TableCell
                                    ...
                                    style={{
                                      ...
                                      cursor: "pointer",
                                      fontWeight:
                                        this.state.sortColumn === column.label
                                          ? "bold"
                                          : "normal",
                                    }}
                          ...
                          itemContent={(index) => {
                            ...
                            const rowData = searchText
                              ? filteredData[index]
                              : loandetails[index];
                            // const rowData = this.state.loandetails[index];
          ...
          <div id="modal1">
            ...
            >
              <div className="modalPopup2">
                <div className="popupTitle">
                  <h2 className="popupheading">Alert</h2>
                  <button
                    type="button"
                    className="closePopup"
                    style={{ minWidth: "30px" }}
...
export default withSnackbar(VA_Pooldetails);
